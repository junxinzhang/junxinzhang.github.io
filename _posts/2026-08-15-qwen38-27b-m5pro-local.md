...
faq:
  ...
  - question: "GGUF 28 和 MLX 40 是什么意思？"
    answer: "都是这台 M5 Pro 上的解码速度，单位是 token/秒。28 是官方 GGUF 标签 qwen3.8:27b（Q4_K_M）热身后的体感，40 是同机 MLX 标签 qwen3.8:27b-mlx（nvfp4）。不是模型更聪明，是推理引擎换了。GGUF 是跨平台默认路径，MLX 是苹果统一内存那一套。两边量化也不同，所以不是纯引擎对比。"
