...
*我是 Jason，自己一个人做 AI 产品。Muse 住进我的 iPhone 两天了。日历、邮件、行程，全在它手上。我打开 App 的次数从每天几十次降到了个位数。代理站在前面，App 退到后面。这个方向回不去了。*
